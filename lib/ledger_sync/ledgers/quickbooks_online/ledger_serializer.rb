...
Gem.find_files('ledger_sync/ledgers/quickbooks_online/ledger_serializer_type/**/*.rb').each { |path| require path }
...
Gem.find_files('ledger_sync/ledgers/quickbooks_online/**/ledger_serializer.rb').each { |path| require path }
