...
RSpec.describe LedgerSync::Adaptors::QuickBooksOnline::Bill::Operations::Update do
  ...
  let(:bill) { LedgerSync::Bill.new(ledger_id: '123', account: account, vendor: vendor, currency: 'USD', memo: 'Memo 1', transaction_date: Date.new(2019, 9, 1), due_date: Date.new(2019, 9, 1), line_items: [])}
