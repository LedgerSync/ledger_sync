...
RSpec.describe LedgerSync::Adaptors::QuickBooksOnline::Account::Operations::Upsert do
  ...
  let(:account1) { LedgerSync::Account.new(name: 'Test', account_type: 'bank', account_sub_type: 'cash_on_hand')}
  let(:account2) { LedgerSync::Account.new(ledger_id: '123', name: 'Test', account_type: 'bank', account_sub_type: 'cash_on_hand')}
