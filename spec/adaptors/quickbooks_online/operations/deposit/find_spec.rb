...
RSpec.describe LedgerSync::Adaptors::QuickBooksOnline::Deposit::Operations::Find do
  ...
  let(:resource) { LedgerSync::Deposit.new(ledger_id: '123', account: account, department: department, currency: 'USD', memo: 'Memo 1', transaction_date: Date.new(2019, 9, 1), line_items: [])}
