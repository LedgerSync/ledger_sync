...
RSpec.describe LedgerSync::Adaptors::QuickBooksOnline::Transfer::Operations::Create do
  ...
  let(:resource) { LedgerSync::Transfer.new(from_account: from_account, to_account: to_account, amount: 0, currency: 'USD', memo: 'Memo 1', transaction_date: Date.new(2019, 9, 1))}
