...
RSpec.describe LedgerSync::Adaptors::QuickBooksOnline::Transfer::Operations::Find do
  ...
  let(:resource) { LedgerSync::Transfer.new(ledger_id: '123', from_account: from_account, to_account: to_account, amount: 0, currency: FactoryBot.create(:currency, :without_test_run_id, name: 'United States Dollars', symbol: 'USD'), memo: 'Memo 1', transaction_date: Date.new(2019, 9, 1))}
