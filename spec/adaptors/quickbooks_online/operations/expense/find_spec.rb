...
RSpec.describe LedgerSync::Adaptors::QuickBooksOnline::Expense::Operations::Find do
  ...
  let(:resource) { LedgerSync::Expense.new(ledger_id: '123', account: account, entity: vendor, currency: FactoryBot.create(:currency, :without_test_run_id, name: 'United States Dollars', symbol: 'USD'), memo: 'Memo 1', payment_type: 'cash', transaction_date: Date.new(2019, 9, 1), line_items: []) }
