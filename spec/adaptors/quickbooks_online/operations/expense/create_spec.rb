...
RSpec.describe LedgerSync::Adaptors::QuickBooksOnline::Expense::Operations::Create do
  ...
  let(:expense) { LedgerSync::Expense.new(account: account, entity: vendor, currency: 'USD', memo: 'Memo 1', payment_type: 'cash', transaction_date: Date.new(2019, 9, 1), line_items: []) }
