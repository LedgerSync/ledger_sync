...
RSpec.describe LedgerSync::Adaptors::Test::Expense::Operations::Find do
  ...
  let(:expense) { LedgerSync::Expense.new(ledger_id: '123', account: account, vendor: vendor, currency: 'USD', memo: 'Memo 1', payment_type: 'cash', transaction_date: Date.new(2019, 9, 1), line_items: [])}
