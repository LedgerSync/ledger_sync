...
RSpec.describe LedgerSync::Adaptors::Test::Expense::Operations::Find do
  ...
  let(:expense) { LedgerSync::Expense.new(ledger_id: '123', account: account, entity: vendor, reference_number: 'Ref123', currency: FactoryBot.create(:currency, symbol: 'USD'), memo: 'Memo 1', payment_type: 'cash', transaction_date: Date.new(2019, 9, 1), line_items: []) }
