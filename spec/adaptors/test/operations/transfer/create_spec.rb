...
RSpec.describe LedgerSync::Adaptors::Test::Transfer::Operations::Create do
  ...
  let(:transfer) { LedgerSync::Transfer.new(from_account: from_account, to_account: to_account, amount: 0, currency: FactoryBot.create(:currency, symbol: 'USD'), memo: 'Memo 1', transaction_date: Date.new(2019, 9, 1))}
