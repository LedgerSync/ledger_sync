...
RSpec.describe LedgerSync::Adaptors::Adaptor, type: :serializable do
  ...
  it do
    h = { root: 'LedgerSync::Adaptors::NetSuite::Adaptor/be8b28e86017b6ea4cc7b1cfcc36b63e',
          objects: { 'LedgerSync::Adaptors::NetSuite::Adaptor/be8b28e86017b6ea4cc7b1cfcc36b63e' =>
        { id: 'LedgerSync::Adaptors::NetSuite::Adaptor/be8b28e86017b6ea4cc7b1cfcc36b63e',
        ...
        { id: 'LedgerSync::AdaptorConfiguration/1cd7e22598138201307ec96400c39b23',
          ...
          data: { module_string: 'NetSuite',
                  root_key: :netsuite,
                  base_module: 'LedgerSync::Adaptors::NetSuite',
                  name: 'NetSuite REST',
                  adaptor_class: 'LedgerSync::Adaptors::NetSuite::Adaptor',
                  aliases: [] } } } }

    expect(netsuite_adaptor.simply_serialize).to eq(h)
  end
  ...
  it do
    ...
    expect(adaptor1.simply_serialize).to eq(adaptor2.simply_serialize)
    expect(adaptor1.simply_serialize).not_to eq(adaptor3.simply_serialize)
