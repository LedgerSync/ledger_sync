...
module QuickBooksOnlineHelpers # rubocop:disable Metrics/ModuleLength
  STUBS = {
    ...
    customer: {
      ...
      search_url: 'https://sandbox-quickbooks.api.intuit.com/v3/company/realm_id/query?query=SELECT%20*%20FROM%20'\
                  "Customer%20WHERE%20DisplayName%20LIKE%20'%25Sample%20Customer%25'%20STARTPOSITION%201%20MAXRESULTS"\
                  '%2010'
    },
    bill_payment: {
      ledger_id: '123',
      ...
      .to_return(
        ...
        body: { 'Vendor' =>
          { 'Balance' => 0,
            ...
            'Active' => true,
            'PrimaryEmailAddr' => { 'Address' => 'test@example.com' } },
                'time' => '2019-09-12T09:03:28.905-07:00' }.to_json,
        headers: {}
      )
  end
      ...
      .to_return(
        ...
        body: { 'Vendor' =>
          { 'Balance' => 0,
            ...
            'Active' => true,
            'PrimaryEmailAddr' => { 'Address' => 'test@example.com' } },
                'time' => '2019-09-12T09:06:41.852-07:00' }.to_json,
        headers: {}
      )
  end
  ...
  def stub_search_vendor
    stub_request(
      :get,
      'https://sandbox-quickbooks.api.intuit.com/v3/company/realm_id/query?query=SELECT%20*%20FROM%20Vendor%20WHERE%20'\
      "DisplayName%20LIKE%20'%25Sample%20Vendor%25'%20STARTPOSITION%201%20MAXRESULTS%2010"
    )
      .with(
        headers: {
          'Accept' => 'application/json',
          ...
          { 'Name' => 'Test Department',
            ...
            { 'CreateTime' => '2019-12-04T14:24:59-08:00',
              'LastUpdatedTime' => '2019-12-04T14:24:59-08:00' } },
                'time' => '2019-12-04T14:24:59.846-08:00' }.to_json,
        headers: {}
      )
  end
  ...
  def stub_search_department
    stub_request(
      :get,
      'https://sandbox-quickbooks.api.intuit.com/v3/company/realm_id/query?query=SELECT%20*%20FROM%20Department%20'\
      "WHERE%20Name%20LIKE%20'%25Test%20Department%25'%20STARTPOSITION%201%20MAXRESULTS%2010"
    )
      .with(
        headers: {
          'Accept' => 'application/json',
      ...
      .to_return(
        ...
        body: { 'Department' =>
          { 'Name' => 'Test Department',
            'SubDepartment' => true,
            'ParentRef' => { 'value' => nil },
            'FullyQualifiedName' => 'Renamed Department:Test Department',
            'Active' => true,
            'domain' => 'QBO',
            'sparse' => false,
            'Id' => '123',
          ...
          { 'Name' => 'Test Class',
            ...
            { 'CreateTime' => '2019-12-04T08:34:10-08:00',
              'LastUpdatedTime' => '2019-12-04T08:34:10-08:00' } },
                'time' => '2019-12-04T08:34:10.943-08:00' }.to_json,
        headers: {}
      )
  end
  ...
  def stub_search_ledger_class
    stub_request(
      :get,
      'https://sandbox-quickbooks.api.intuit.com/v3/company/realm_id/query?query=SELECT%20*%20FROM%20Class%20WHERE%20'\
      "Name%20LIKE%20'%25Test%20Class%25'%20STARTPOSITION%201%20MAXRESULTS%2010"
    )
      .with(
        headers: {
          'Accept' => 'application/json',
      ...
      .to_return(
        ...
        body: { 'Class' =>
          { 'Name' => 'Test Class',
            ...
            { 'CreateTime' => '2019-12-04T08:34:10-08:00',
              'LastUpdatedTime' => '2019-12-04T08:34:10-08:00' } },
                'time' => '2019-12-04T08:35:42.814-08:00' }.to_json,
        headers: {}
      )
  end
