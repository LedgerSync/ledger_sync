...
RSpec.describe 'quickbooks_online/journal_entries/update', type: :feature do
  ...
  context '#perform' do
    subject { LedgerSync::Adaptors::QuickBooksOnline::JournalEntry::Operations::Update.new(**input).perform }
