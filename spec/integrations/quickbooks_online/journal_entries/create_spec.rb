...
RSpec.describe 'quickbooks_online/journal_entries/create', type: :feature do
  include InputHelpers
  include AdaptorHelpers
  include QuickBooksHelpers

  before {
    stub_create_journal_entry
  }
  ...
  context '#perform' do
    subject { LedgerSync::Adaptors::QuickBooksOnline::JournalEntry::Operations::Create.new(**input).perform }
