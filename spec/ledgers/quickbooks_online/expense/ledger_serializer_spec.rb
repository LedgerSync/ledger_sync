...
RSpec.describe LedgerSync::Ledgers::QuickBooksOnline::Expense::LedgerSerializer do
  ...
  let(:h) do
    {
      ...
      'DocNumber' => 'Ref123',
      'PaymentType' => LedgerSync::Ledgers::QuickBooksOnline::LedgerSerializerType::PaymentType.mapping[payment_type],
      ...
      'Line' => line_items.map do |line_item|
        LedgerSync::Ledgers::QuickBooksOnline::ExpenseLineItem::LedgerSerializer.new(
          resource: line_item
        ).to_ledger_hash
      end
    }
