...
RSpec.describe LedgerSync::Ledgers::QuickBooksOnline::Deserializer do
  ...
  describe '#deserialize' do
    it 'merges using replace by default' do
      serializer_class = LedgerSync::Ledgers::QuickBooksOnline::Bill::Serializer
      deserializer_class = LedgerSync::Ledgers::QuickBooksOnline::Bill::Deserializer
